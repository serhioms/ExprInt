...
public class SetsParser extends Parser {
	...
	public static class ExprContext extends ParserRuleContext {
		...
		public TerminalNode OP_ADD() { return getToken(SetsParser.OP_ADD, 0); }
	...
	public static class TermContext extends ParserRuleContext {
		...
		public TerminalNode OP_MUL() { return getToken(SetsParser.OP_MUL, 0); }
	...
	public static class IntsContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SetsVisitor ) return ((SetsVisitor<? extends T>)visitor).visitInts(this);
			else return visitor.visitChildren(this);
		}
	}
